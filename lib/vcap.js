...
var VcapClient = module.exports = function (info, callback) {
    ...
    var authedRequest = function (uri, page, method, json, callback) {
        ...
        if (token) {
            return makeRequest(uri, page, method, json, function (err, result) {
                if (err) {
    ...
    var InnerCollection = function (parentCollection, id, collection) {
        this.get = function (callback) {
            authedRequest(getPath(parentCollection, id, collection), null, 'GET',
        ...
        this.put = function (object, callback) {
            authedRequest(getPath(parentCollection, id, collection), null,
                    'PUT', object, function (err, result) {
